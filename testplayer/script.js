!function() {
    var e, t = {
        3683: function(e, t, n) {
            ...
            function T(e, t) {
                return !t || "object" !== N(t) && "function" != typeof t ? j(e) : t
            }
            function j(e) {
                if (void 0 === e)
                    throw new ReferenceError("this hasn't been initialised - super() hasn't been called");
                ...
                function u(e) {
                    ...
                    if (t.videoSources.length) {
                        ...
                        case "encodingFailed":
                            break;
                        default:
                            x.warn("VIDEO DEBUG:", "Video files don't exist")
                        }
                    o.PageStore.on("switched_media_auto_play", t.onUpdateMediaAutoPlay.bind(j(t))),
                    ...
                    t.onPlayerInit = t.onPlayerInit.bind(j(t)),
                    t.onClickNext = t.onClickNext.bind(j(t)),
                    t.onClickPrevious = t.onClickPrevious.bind(j(t)),
                    t.onStateUpdate = t.onStateUpdate.bind(j(t)),
                    t.onVideoEnd = t.onVideoEnd.bind(j(t)),
                    t.onVideoRestart = t.onVideoRestart.bind(j(t)),
                    t
                }
                return t = u,
                (n = [{
            ...
            function ne(e) {
                ...
                function k() {
                    var e = Z(o.MediaPageStore.get("users"))
                      , t = [];
                    e.forEach((function(e) {
                        t.push({
                            id: e.username,
            ...
            function re(e) {
                ...
                }, ee, " removal"), a.createElement("span", {
                    className: "popup-message-main"
                }, "You're willing to remove ", X, " permanently?")), a.createElement("hr", null), a.createElement("span", {
            ...
            function ae(e) {
                ...
                a.useRef)(null), r = (0,
                a.useRef)(null), o = G((0,
                a.useState)(!0), 2), l = o[0], s = o[1], u = G((0,
                ...
                }, l ? "Show less" : "Read more") : null, i.MemberContext._currentValue.can.deleteComment ? a.createElement(re, {
            ...
            var ie = function(e) {
                ...
                }, "Comments are disabled"), i.MemberContext._currentValue.can.readComment && (o.MediaPageStore.get("media-data").enable_comments || i.MemberContext._currentValue.can.editMedia) ? a.createElement("h2", null, t ? 1 < t ? t + " Comments" : t + " " + ee : o.MediaPageStore.get("media-data").enable_comments ? "No comment yet" : "") : null)
            };
            function oe(e) {
                var t = G((0,
                ...
                a.useState)(!1), 2)
                  ...
                  , d = u[1];
                function m() {
                    var e = Z(o.MediaPageStore.get("media-comments"))
                      , t = videojs("vjs_video_3");
                    MediaCMS.features.media.actions.timestampTimebar && function(e) {
                        "object" !== $(e.markers) && e.markers({
                            markerStyle: Q,
                            markerTip: {
                                display: !0,
                                text: function(e) {
                    ...
                    !0 === MediaCMS.features.media.actions.comment_mention && e.forEach((function(e) {
                        e.text = e.text.split("@(_").join('<a href="/user/').split("_)[_").join('">').split("_]").join("</a>")
                    }
                    )),
                    t.one("loadedmetadata", (function() {
                        e.forEach((function(e) {
                            ...
                            e.text = (n = e.text,
                            r = t,
                            a = new RegExp("((\\d)?\\d:)?(\\d)?\\d:\\d\\d","g"),
                            n.replace(a, (function(e, t) {
                                for (var a = e.split(":"), i = 0, l = 1, s = new URLSearchParams(window.location.search); a.length > 0; )
                                    i += l * parseInt(a.pop(), 10),
                                    l *= 60;
                                return MediaCMS.features.media.actions.timestampTimebar && function(e, t, n) {
                                    e.markers.add([{
                                        time: t,
                                        text: n
                                    }])
                                ...
                                s.set("t", i),
                                '<a href="' + o.MediaPageStore.get("media-url").split("?")[0] + "?" + s + '">' + e + "</a>"
                            }
                            )))
                        }
                        )),
                        function() {
                            var e = document.querySelector(".page-main")
                              , t = e.querySelector(".no-comment")
                              , n = o.PageStore.get("config-contents").uploader.postUploadMessage;
                            if ("" === n)
                                t && 0 === comm.length && t.parentNode.removeChild(t);
                            else if (0 === comm.length && "unlisted" === o.MediaPageStore.get("media-data").state) {
                                if (-1 < i.LinksContext._currentValue.profile.media.indexOf(o.MediaPageStore.get("media-data").author_profile) && !t) {
                                    var r = document.createElement("div");
                                    r.setAttribute("role", "alert"),
                                    r.setAttribute("class", "alert info alert-dismissible no-comment"),
                                    r.innerHTML = '<button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">×</span></button>' + n,
                                    e.firstChild ? e.insertBefore(r, e.firstChild) : e.appendChild(r),
                                    r.querySelector("button.close").addEventListener("click", (function(e) {
                                        return r.setAttribute("class", "alert info alert-dismissible hiding"),
                                        setTimeout((function() {
                ...
                }), o.MediaPageStore.get("media-data").enable_comments ? a.createElement(ne, {
                    media_id: n
            ...
            function ye(e) {
                ...
                B.useUser)().userCan
                  ...
                  , r = !o.PageStore.get("config-enabled").taxonomies.tags || o.PageStore.get("config-enabled").taxonomies.tags.enabled ? ce(o.MediaPageStore.get("media-tags")) : []
                  , l = o.PageStore.get("config-options").pages.media.categoriesWithTitle ? [] : !o.PageStore.get("config-enabled").taxonomies.categories || o.PageStore.get("config-enabled").taxonomies.categories.enabled ? ce(o.MediaPageStore.get("media-categories")) : []
                ...
                function S(e) {
                    ...
                    void 0 !== e && le.info("Removed media '" + e + '"')
                }
                function w(e) {
                    setTimeout((function() {
                    ...
                    void 0 !== e && le.info('Media "' + e + '" removal failed')
                }
                (0,
                a.useEffect)((function() {
                ...
                }, void 0 === o.PageStore.get("config-media-item").displayAuthor || null === o.PageStore.get("config-media-item").displayAuthor || o.PageStore.get("config-media-item").displayAuthor ? a.createElement(de, {
                    link: E,
                    thumb: P,
                    name: e.author.name,
                ...
                }, v ? "SHOW LESS" : "SHOW MORE") : null, r.length ? a.createElement(me, {
                    value: r,
                    title: 1 < r.length ? "Tags" : "Tag",
                    id: "tags"
                }) : null, l.length ? a.createElement(me, {
                    value: l,
                ...
                }, t.editMedia ? a.createElement(fe, {
                    link: o.MediaPageStore.get("media-data").edit_url
                }) : null, t.editSubtitle && "video" === o.MediaPageStore.get("media-data").media_type ? a.createElement(pe, {
                ...
                }, "PROCEED"))))) : null)), a.createElement(oe, null))
            }
            function he(e, t) {
                return function(e) {
                    if (Array.isArray(e))
            ...
            function Ae(e, t, n, r, i, o, l) {
                ...
                }), a.createElement("div", null, a.createElement(Pe, {
                    mediaUrl: s,
                    submitReportForm: o,
                    cancelReportForm: l
                }))))),
            ...
            var Ce = "more-options active-options";
            function xe(e) {
                var t = (0,
                B.useUser)().userCan
                ...
                (0,
                a.useEffect)((function() {
                    P(Ae(t, l, e.allowDownload, r, b, N, O))
                }
                ), [b]),
                (0,
                a.useEffect)((function() {
                    return P(Ae(t, l, e.allowDownload, r, b, N, O)),
                    function() {
            ...
            function Re(e) {
                var t, n = Ve((0,
                B.usePopup)(), 3), r = n[0], i = n[1], o = n[2], l = Ve((0,
            ...
            function Qe(e) {
                ...
                return (0,
                a.useEffect)((function() {
                    u(new Fe.Z(n.current,".sh-option"))
                }
                ), [g]),
                (0,
                a.useEffect)((function() {
                ...
                (0,
                a.useEffect)((function() {
                    o.PageStore.on("window_resize", N),
                    ...
                    n >= 1 ? n + ":" + r + ":" + a : r + ":" + a)),
                    function() {
                        o.PageStore.removeListener("window_resize", N),
            ...
            function et(e) {
                var t, n = Ye((0,
                B.usePopup)(), 3), r = n[0], i = n[1], o = n[2], l = Ye((0,
            ...
            function ut(e, t) {
                return !t || "object" !== ot(t) && "function" != typeof t ? ct(e) : t
            }
            function ct(e) {
                if (void 0 === e)
                    throw new ReferenceError("this hasn't been initialised - super() hasn't been called");
            ...
            var mt = function(e) {
                ...
                function u(e) {
                    ...
                    t.updateStateValues = t.updateStateValues.bind(ct(t)),
                    t
                }
                return t = u,
                (n = [{
                    ...
                    value: function() {
                        ...
                        }, a.createElement("div", null, i.MemberContext._currentValue.can.likeMedia ? a.createElement(we, null) : null, i.MemberContext._currentValue.can.dislikeMedia ? a.createElement(ve, null) : null, i.MemberContext._currentValue.can.shareMedia ? a.createElement(et, {
                            isVideo: !1
                        }) : null, !i.MemberContext._currentValue.is.anonymous && i.MemberContext._currentValue.can.saveMedia && -1 < i.PlaylistsContext._currentValue.mediaTypes.indexOf(o.MediaPageStore.get("media-type")) ? a.createElement(Re, null) : null, this.props.allowDownload && i.MemberContext._currentValue.can.downloadMedia ? this.downloadLink ? a.createElement(tt, {
                            link: this.downloadLink,
                            title: this.props.title
                        }) : a.createElement(it, null) : null, a.createElement(xe, {
            ...
            var It = function(e) {
                ...
                function s(e) {
                    ...
                    t.onVideoLoad = t.onVideoLoad.bind(kt(t)),
            ...
            function Qt(e) {
                ...
                n && n.length ? a.createElement(Bt.s, {
                    className: "items-list-hor",
            ...
            function Kt(e, t) {
                return !t || "object" !== Zt(t) && "function" != typeof t ? Xt(e) : t
            }
            function Xt(e) {
                if (void 0 === e)
                    throw new ReferenceError("this hasn't been initialised - super() hasn't been called");
            ...
            var tn = function(e) {
                ...
                function u(e) {
                    ...
                    t.onHeaderClick = t.onHeaderClick.bind(Xt(t)),
                    t.onLoopClick = t.onLoopClick.bind(Xt(t)),
                    t.onShuffleClick = t.onShuffleClick.bind(Xt(t)),
                    t.onSaveClick = t.onSaveClick.bind(Xt(t)),
                    t.onLoopRepeatUpdate = t.onLoopRepeatUpdate.bind(Xt(t)),
                    t.onShuffleUpdate = t.onShuffleUpdate.bind(Xt(t)),
                    t.onPlaylistSaveUpdate = t.onPlaylistSaveUpdate.bind(Xt(t)),
            ...
            function on(e, t) {
                return !t || "object" !== nn(t) && "function" != typeof t ? ln(e) : t
            }
            function ln(e) {
                if (void 0 === e)
                    throw new ReferenceError("this hasn't been initialised - super() hasn't been called");
            ...
            var un = function(e) {
                ...
                function s(e) {
                    ...
                    return t.onMediaLoad = t.onMediaLoad.bind(ln(t)),
                    t
                }
                return t = s,
                (n = [{
                    ...
                    value: function() {
                        ...
                        }, this.state.isPlaylistPage ? a.createElement(tn, {
                            activeItem: this.state.activeItem,
                            playlistData: this.props.playlistData
                        }) : "video" === this.state.mediaType || "audio" === this.state.mediaType ? a.createElement(Ht, null) : null, a.createElement(Qt, {
            ...
            var hn = function(e) {
                ...
                function s(e) {
                    ...
                    t.onWindowResize = t.onWindowResize.bind(pn(t)),
                    t.onMediaLoad = t.onMediaLoad.bind(pn(t)),
                    t.onMediaLoadError = t.onMediaLoadError.bind(pn(t)),
                    t.onPagePlaylistLoad = t.onPagePlaylistLoad.bind(pn(t)),
                ...
                (n = [{
                    ...
                    value: function() {
                        ...
                        return this.state.mediaLoadFailed ? a.createElement("div", {
                            className: e
                        }, a.createElement(Ut, null)) : a.createElement("div", {
                            className: e
                        }, [a.createElement("div", {
                            className: "viewer-container",
                            ...
                            className: t
                        }, !this.state.wideLayout || this.state.isVideoMedia && this.state.theaterMode ? [a.createElement(It, {
                            key: "viewer-info"
                        }), this.state.pagePlaylistLoaded ? a.createElement(un, {
                            key: "viewer-sidebar",
                            mediaId: o.MediaPageStore.get("media-id"),
                            playlistData: o.MediaPageStore.get("playlist-data")
                        }) : null] : [this.state.pagePlaylistLoaded ? a.createElement(un, {
                            key: "viewer-sidebar",
                            mediaId: o.MediaPageStore.get("media-id"),
                            playlistData: o.MediaPageStore.get("playlist-data")
                        }) : null, a.createElement(It, {
                            key: "viewer-info"
                        })])])
                    }
                }]) && dn(t.prototype, n),
            ...
            if (window.MediaCMS.site.devEnv) {
                var Pn = function() {
                  ...
                  , kn = Pn.mediaId
                  , _n = Pn.playlistId;
                kn && (window.MediaCMS.mediaId = kn),
                _n && (window.MediaCMS.playlistId = _n)
            }
            var Mn = function(e) {
                !function(e, t) {
                    if ("function" != typeof t && null !== t)
        ...
        160: function(e, t, n) {
            ...
            function h(e) {
                ...
                var T, j = null, V = null, L = null, R = ((T = new (l())(e.pageLink).query) ? ((T = T.substring(1)).split("&"),
                ...
                function U(e) {
                    if (void 0 !== e && e && void 0 !== e.data && e.data) {
                        ...
                        var a = []
                          , o = null
                          , l = (0,
                        d.RA)(V.encodings_info, V.hls_info)
                          , s = null
                          , c = null;
                        if ("string" == typeof V.poster_url ? o = (0,
                        u.formatInnerLink)(V.poster_url, n.url) : "string" == typeof V.thumbnail_url && (o = (0,
                        u.formatInnerLink)(V.thumbnail_url, n.url)),
                        Object.keys(l).length) {
                            ...
                            for (r in V.encodings_info[y])
                                V.encodings_info[y].hasOwnProperty(r) && m.support[r] && (t = V.encodings_info[y][r].url) && (t = (0,
                                u.formatInnerLink)(t, n.url),
                                a.push({
                                    src: t,
                                    encodings_status: V.encodings_info[y][r].status
                                }))
                        } else
                            l = null;
                        ...
                        O(V.sprites_url ? {
                            url: (0,
                            u.formatInnerLink)(V.sprites_url, n.url),
                            frame: {
                                width: 160,
                                height: 90,
                                seconds: 10
                ...
                return null !== L && (j = t.media + "/" + L),
                (0,
                r.useEffect)((function() {
                    null !== j && (0,
                    u.getRequest)(j, !1, U, B)
                }
                ), []),
