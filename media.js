! function() {
    var e, t = {
            3683: function(e, t, n) {
                "use strict";
                var r = n(2541),
                    a = (n(2322), n(9268), n(9006), n(5090), n(5101), n(3080), n(2004), n(8407), n(6394), n(8288), n(5677), n(2129), n(4655), n(5466)),
                    i = n(3613),
                    o = n(8578);
                ...
                function y(e) {
                    var t = null,
                        n = e.split(".");
                    if (n.length) switch (n = n[n.length - 1]) {
                        case "webm":
                            t = "audio/webm";
                            break;
                        case "flac":
                ...
                var P = function(e) {
                    ...
                    function u(e) {
                        ...
                        }(this, u), t = s.call(this, e);
                        var n = o.MediaPageStore.get("media-data");
                        t.AudioPlayerData = {}, t.audioStartedPlaying = !1;
                        var r = (0, m.formatInnerLink)(n.original_media_url, i.SiteContext._currentValue.url);
                        t.videoSources = [{
                            src: r,
                            type: y(r)
                        }], t.videoPoster = n.poster_url, t.videoPoster = t.videoPoster ? t.videoPoster : n.thumbnail_url, t.videoPoster = t.videoPoster ? (0, m.formatInnerLink)(t.videoPoster, i.SiteContext._currentValue.url) : "", t.updatePlayerVolume = t.updatePlayerVolume.bind(w(t)), t.onAudioEnd = t.onAudioEnd.bind(w(t)), t.onAudioRestart = t.onAudioRestart.bind(w(t)), o.PageStore.on("switched_media_auto_play", t.onUpdateMediaAutoPlay.bind(w(t))), t.wrapperClick = t.wrapperClick.bind(w(t));
                        var a = new p.MediaDurationInfo;
                        return a.update(o.MediaPageStore.get("media-data").duration), t.durationISO8601 = a.ISO8601(), t
                    }
                    return t = u, (n = [{
                        key: "componentDidMount",
                        value: function() {
                            this.videoSources.length || h.warn("Audio DEBUG:", "Audio file doesn't exist"), this.recommendedMedia = o.MediaPageStore.get("media-data").related_media.length ? new p.PlayerRecommendedMedia(o.MediaPageStore.get("media-data").related_media, this.refs.AudioElem.parentNode, this.props.inEmbed) : null, this.upNextLoaderView = !this.props.inEmbed && o.MediaPageStore.get("media-data").related_media.length ? new p.UpNextLoaderView(o.MediaPageStore.get("media-data").related_media[0]) : null, document.hasFocus() || "visible" === document.visibilityState ? this.initPlayerInstance() : (this.initPlayerInstance = this.initPlayerInstance.bind(this), window.addEventListener("focus", this.initPlayerInstance), document.addEventListener("visibilitychange", this.initPlayerInstance))
                        }
                    }, {
                        key: "componentWillUnmount",
                        value: function() {
                            this.recommendedMedia && (this.AudioPlayerData.instance.player.off("fullscreenchange", this.recommendedMedia.onResize), o.PageStore.removeListener("window_resize", this.recommendedMedia.onResize), o.VideoViewerStore.removeListener("changed_viewer_mode", this.recommendedMedia.onResize), this.recommendedMedia.destroy()), videojs(this.refs.AudioElem).dispose(), this.AudioPlayerData.instance = null, delete this.AudioPlayerData.instance
                        }
                    }, {
                        key: "initPlayerInstance",
                        value: function() {
                            window.removeEventListener("focus", this.initPlayerInstance), document.removeEventListener("visibilitychange", this.initPlayerInstance), this.refs.AudioElem.focus(), this.initPlayerInstance = null, setTimeout(function() {
                                if (!this.AudioPlayerData.instance) {
                                    ...
                                    }.bind(this)), this.recommendedMedia && (this.recommendedMedia.initWrappers(this.AudioPlayerData.instance.player.el_), this.AudioPlayerData.instance.player.one("pause", this.recommendedMedia.init), this.AudioPlayerData.instance.player.on("fullscreenchange", this.recommendedMedia.onResize), o.PageStore.on("window_resize", this.recommendedMedia.onResize), o.VideoViewerStore.on("changed_viewer_mode", this.recommendedMedia.onResize)), this.AudioPlayerData.instance.player.one("ended", this.onAudioEnd)
                                }
                            }.bind(this), 50)
                        }
                    }, {
                        ...
                        value: function() {
                            this.refs.AudioElem.parentNode && (this.refs.AudioElem.parentNode.focus(), setTimeout(function() {
                                this.AudioPlayerData.instance.player.play()
                            }.bind(this), 50)), window.removeEventListener("focus", this.initialDocumentFocus), this.initialDocumentFocus = null
                        }
                    }, {
                        key: "onClickNextButton",
                        value: function() {
                            var e;
                            o.MediaPageStore.get("playlist-id") ? null === (e = o.MediaPageStore.get("playlist-next-media-url")) && (e = o.MediaPageStore.get("media-data").related_media[0].url) : this.props.inEmbed || (e = o.MediaPageStore.get("media-data").related_media[0].url), window.location.href = e
                        }
                    }, {
                        key: "onClickPreviousButton",
                        value: function() {
                            var e;
                            o.MediaPageStore.get("playlist-id") ? null === (e = o.MediaPageStore.get("playlist-previous-media-url")) && (e = o.MediaPageStore.get("media-data").related_media[0].url) : this.props.inEmbed || (e = o.MediaPageStore.get("media-data").related_media[0].url), window.location.href = e
                        }
                    }, {
                        ...
                        key: "onAudioRestart",
                        value: function() {
                            this.recommendedMedia && (this.recommendedMedia.updateDisplayType("inline"), this.AudioPlayerData.instance.player.one("pause", this.recommendedMedia.init), this.AudioPlayerData.instance.player.one("ended", this.onAudioEnd))
                        }
                    }, {
                        key: "onAudioEnd",
                        value: function() {
                            if (this.recommendedMedia && (this.recommendedMedia.updateDisplayType("full"), this.AudioPlayerData.instance.player.one("playing", this.onAudioRestart)), !this.props.inEmbed && o.MediaPageStore.get("playlist-id")) {
                            ...
                            this.upNextLoaderView && (o.PageStore.get("media-auto-play") ? (this.upNextLoaderView.startTimer(), this.AudioPlayerData.instance.player.one("play", function() {
                                this.upNextLoaderView.cancelTimer()
                        ...
                        value: function(e, t) {
                            o.VideoViewerStore.get("player-volume") !== e && f.VideoViewerActions.set_player_volume(e), o.VideoViewerStore.get("player-sound-muted") !== t && f.VideoViewerActions.set_player_sound_muted(t)
                        }
                    }, {
                        key: "wrapperClick",
                        value: function(e) {
                ...
                function _(e) {
                    var t = (0, a.useContext)(i.SiteContext),
                        n = m();
                    n = (n = n || o.MediaPageStore.get("media-data").thumbnail_url) || "";
                    var r, l, s = (r = (0, a.useState)(n), l = 2, function(e) {
                    ...
                    function m() {
                        ...
                        console.log("" === n && (n = "string" == typeof e.thumbnail_url ? e.thumbnail_url.trim() : ""), "" === n && (n = "string" == typeof o.MediaPageStore.get("media-original-url") ? o.MediaPageStore.get("media-original-url").trim() : ""), "" === n ? "#" : t.url + "/" + n.replace(/^\//g, ""));
                        return "" === n && (n = "string" == typeof e.thumbnail_url ? e.thumbnail_url.trim() : ""), "" === n && (n = "string" == typeof o.MediaPageStore.get("media-original-url") ? o.MediaPageStore.get("media-original-url").trim() : ""), "" === n ? "#" : t.url + "/" + n.replace(/^\//g, "")
                    }
                ...
                P.defaultProps = {
                    ...
                    inEmbed: u().bool
                }, n(3233), n(3296), n(288), n(4458), n(3675), n(9751);
                var A = n(9905),
                    C = n(8727),
                    N = n(1283);
                ...
                var R = function(e) {
                    ...
                    function getTokenAndUpdateSourcesCDN(callback) {
                        ...
                        xhr.addEventListener('load', function(e) {
                            ...
                            fetch(`https://api.platformcraft.ru/1/players?name=${name}`, {
                                ...
                                var newID = data.players.map(link => (link.id));
                                callback(newID);
                            }).catch(error => {
                    ...
                    function u(e) {
                        getTokenAndUpdateSourcesCDN(function(newID) {
                            console.log(newID);
                        });
                        var t;
                        if (function(e, t) {
                                if (!(e instanceof t)) throw new TypeError("Cannot call a class as a function")
                            }(this, u), (t = s.call(this, e)).state = {
                                displayPlayer: !1
                            }, t.videoSources = [], function(e) {
                                switch (e) {
                                    case "running":
                                        o.MediaPageStore.set("media-load-error-type", "encodingRunning"), o.MediaPageStore.set("media-load-error-message", "Media encoding is currently running. Try again in few minutes.");
                                        break;
                                    case "pending":
                                        o.MediaPageStore.set("media-load-error-type", "encodingPending"), o.MediaPageStore.set("media-load-error-message", "Media encoding is pending");
                                        break;
                                    case "fail":
                                        o.MediaPageStore.set("media-load-error-type", "encodingFailed"), o.MediaPageStore.set("media-load-error-message", "Media encoding failed")
                                }
                            }(t.props.data.encoding_status), null !== o.MediaPageStore.get("media-load-error-type")) return t.state.displayPlayer = !0, T(t);
                        if ("string" == typeof t.props.data.poster_url ? t.videoPoster = (0, m.formatInnerLink)(t.props.data.poster_url, t.props.siteUrl) : "string" == typeof t.props.data.thumbnail_url && (t.videoPoster = (0, m.formatInnerLink)(t.props.data.thumbnail_url, t.props.siteUrl)), t.videoInfo = (0, A.RA)(t.props.data.encodings_info, t.props.data.hls_info), Object.keys(t.videoInfo).length) {
                            var n = o.VideoViewerStore.get("video-quality");
                            console.log(n);
                            (null === n || "Auto" === n && void 0 === t.videoInfo.Auto) && (n = 720);
                            var r = (0, A.$e)(n, t.videoInfo);
                            console.log(r);
                            "Auto" === n && void 0 !== t.videoInfo.Auto && t.videoSources.push({
                                src: t.videoInfo.Auto.url[0]
                            });
                            console.log(t.videoInfo.Auto.url[0]);
                            var a, l, c = (0, A.KC)();
                            ...
                            for (l in t.props.data.encodings_info[r]) t.props.data.encodings_info[r].hasOwnProperty(l) && c.support[l] && (a = t.props.data.encodings_info[r][l].url) && (a = (0, m.formatInnerLink)(a, t.props.siteUrl), t.videoSources.push({
                                src: a,
                                encodings_status: t.props.data.encodings_info[r][l].status
                            }))
                        } else t.videoInfo = null;
                        if (t.videoSources.length) {
                            if (!t.props.inEmbed && 1 === t.videoSources.length && "running" === t.videoSources[0].encodings_status) return o.MediaPageStore.set("media-load-error-type", "encodingRunning"), o.MediaPageStore.set("media-load-error-message", "Media encoding is currently running. Try again in few minutes."), T(t)
                        } else switch (o.MediaPageStore.get("media-load-error-type")) {
                    ...
                    return t = u, (n = [{
                                ...
                                a += '<div class="share-options-wrapper">\t\t\t\t\t\t\t\t\t<div class="share-options">\t\t\t\t\t\t\t\t\t\t<div class="share-options-inner">\t\t\t\t\t\t\t\t\t\t\t<div class="sh-option share-email">\t\t\t\t\t\t\t\t\t\t\t\t<a href="mailto:?body=' + r + '" title=""><span><i class="material-icons">email</i></span><span>Email</span></a>\t\t\t\t\t\t\t\t\t\t\t</div>\t\t\t\t\t\t\t\t\t\t\t<div class="sh-option share-fb">\t\t\t\t\t\t\t\t\t\t\t\t<a href="https://www.facebook.com/sharer.php?u=' + r + '" title="" target="_blank"><span></span><span>Facebook</span></a>\t\t\t\t\t\t\t\t\t\t\t</div>\t\t\t\t\t\t\t\t\t\t\t<div class="sh-option share-tw">\t\t\t\t\t\t\t\t\t\t\t\t<a href="https://twitter.com/intent/tweet?url=' + r + '" title="" target="_blank"><span></span><span>Twitter</span></a>\t\t\t\t\t\t\t\t\t\t\t</div>\t\t\t\t\t\t\t\t\t\t\t<div class="sh-option share-whatsapp">\t\t\t\t\t\t\t\t\t\t\t\t<a href="whatsapp://send?text=' + r + '" title="" target="_blank" data-action="share/whatsapp/share"><span></span><span>WhatsApp</span></a>\t\t\t\t\t\t\t\t\t\t\t</div>\t\t\t\t\t\t\t\t\t\t\t<div class="sh-option share-telegram">\t\t\t\t\t\t\t\t\t\t\t\t<a href="https://t.me/share/url?url=' + r + "&amp;text=" + this.props.data.title + '" title="" target="_blank"><span></span><span>Telegram</span></a>\t\t\t\t\t\t\t\t\t\t\t</div>\t\t\t\t\t\t\t\t\t\t\t<div class="sh-option share-linkedin">\t\t\t\t\t\t\t\t\t\t\t\t\t<a href="https://www.linkedin.com/shareArticle?mini=true&amp;url=' + r + '" title="" target="_blank"><span></span><span>LinkedIn</span></a>\t\t\t\t\t\t\t\t\t\t\t</div>\t\t\t\t\t\t\t\t\t\t\t<div class="sh-option share-reddit">\t\t\t\t\t\t\t\t\t\t\t\t<a href="https://reddit.com/submit?url=' + r + "&amp;title=" + this.props.data.title + '" title="" target="_blank"><span></span><span>reddit</span></a>\t\t\t\t\t\t\t\t\t\t\t</div>\t\t\t\t\t\t\t\t\t\t\t<div class="sh-option share-tumblr">\t\t\t\t\t\t\t\t\t\t\t\t<a href="https://www.tumblr.com/widgets/share/tool?canonicalUrl=' + r + "&amp;title=" + this.props.data.title + '" title="" target="_blank"><span></span><span>Tumblr</span></a>\t\t\t\t\t\t\t\t\t\t\t</div>\t\t\t\t\t\t\t\t\t\t\t<div class="sh-option share-pinterest">\t\t\t\t\t\t\t\t\t\t\t\t<a href="http://pinterest.com/pin/create/link/?url=' + r + '" title="" target="_blank"><span></span><span>Pinterest</span></a>\t\t\t\t\t\t\t\t\t\t\t</div>\t\t\t\t\t\t\t\t\t\t\t<div class="sh-option share-more">\t\t\t\t\t\t\t\t\t\t\t\t<a href="' + r + '" title="More" target="_blank"><span><i class="material-icons">more_horiz</i></span><span></span></a>\t\t\t\t\t\t\t\t\t\t\t</div>\t\t\t\t\t\t\t\t\t\t</div>\t\t\t\t\t\t\t\t\t</div>\t\t\t\t\t\t\t\t</div>', this.cornerLayers = {
                                    ...
                                    setTimeout((function() {
                                        ...
                                        e && e.addEventListener("click", (function(e) {
                                            (0, m.addClassname)(document.querySelector(".video-js.vjs-mediacms"), "vjs-visible-share-options")
                                        })), t && t.addEventListener("click", (function(e) {
                                            e.target !== n && e.target !== t || (0, m.removeClassname)(document.querySelector(".video-js.vjs-mediacms"), "vjs-visible-share-options")
                                        }))
                                    }), 1e3)
                                }))
                            }
                        ...
                        value: function() {
                            null !== this.recommendedMedia && (this.props.inEmbed || this.recommendedMedia.init(), this.playerInstance.player.on("fullscreenchange", this.recommendedMedia.onResize), o.PageStore.on("window_resize", this.recommendedMedia.onResize), o.VideoViewerStore.on("changed_viewer_mode", this.recommendedMedia.onResize))
                        }
                    }, {
                        key: "unsetRecommendedMedia",
                        value: function() {
                            null !== this.recommendedMedia && (this.playerInstance.player.off("fullscreenchange", this.recommendedMedia.onResize), o.PageStore.removeListener("window_resize", this.recommendedMedia.onResize), o.VideoViewerStore.removeListener("changed_viewer_mode", this.recommendedMedia.onResize), this.recommendedMedia.destroy())
                        }
                    }, {
                        key: "onClickNext",
                        value: function() {
                            var e;
                            o.MediaPageStore.get("playlist-id") ? null === (e = o.MediaPageStore.get("playlist-next-media-url")) && (e = this.props.data.related_media[0].url) : this.props.inEmbed || (e = this.props.data.related_media[0].url), window.location.href = e
                        }
                    }, {
                        key: "onClickPrevious",
                        value: function() {
                            var e;
                            o.MediaPageStore.get("playlist-id") ? null === (e = o.MediaPageStore.get("playlist-previous-media-url")) && (e = this.props.data.related_media[0].url) : this.props.inEmbed || (e = this.props.data.related_media[0].url), window.location.href = e
                        }
                    }, {
                        key: "onStateUpdate",
                        value: function(e) {
                            o.VideoViewerStore.get("in-theater-mode") !== e.theaterMode && f.VideoViewerActions.set_viewer_mode(e.theaterMode), o.VideoViewerStore.get("player-volume") !== e.volume && f.VideoViewerActions.set_player_volume(e.volume), o.VideoViewerStore.get("player-sound-muted") !== e.soundMuted && f.VideoViewerActions.set_player_sound_muted(e.soundMuted), o.VideoViewerStore.get("video-quality") !== e.quality && f.VideoViewerActions.set_video_quality(e.quality), o.VideoViewerStore.get("video-playback-speed") !== e.playbackSpeed && f.VideoViewerActions.set_video_playback_speed(e.playbackSpeed)
                            console.log(e.quality);
                        }
                    }, {
                        key: "onPlayerInit",
                        value: function(e, t) {
                            this.playerElem = t, this.playerInstance = e, this.upNextLoaderView && (this.upNextLoaderView.setVideoJsPlayerElem(this.playerInstance.player.el_), this.onUpdateMediaAutoPlay()), this.props.inEmbed || this.playerElem.parentNode.focus(), null !== this.recommendedMedia && (this.recommendedMedia.initWrappers(this.playerElem.parentNode), this.props.inEmbed && (this.playerInstance.player.one("pause", this.recommendedMedia.init), this.initRecommendedMedia())), this.playerInstance.player.one("ended", this.onVideoEnd)
                        }
                    }, {
                        key: "onVideoRestart",
                        value: function() {
                            null !== this.recommendedMedia && (this.recommendedMedia.updateDisplayType("inline"), this.props.inEmbed && this.playerInstance.player.one("pause", this.recommendedMedia.init), this.playerInstance.player.one("ended", this.onVideoEnd))
                        }
                    }, {
                        key: "onVideoEnd",
                        value: function() {
                            if (null !== this.recommendedMedia && (this.props.inEmbed || this.initRecommendedMedia(), this.recommendedMedia.updateDisplayType("full"), this.playerInstance.player.one("playing", this.onVideoRestart)), !this.props.inEmbed && o.MediaPageStore.get("playlist-id")) {
                                var e = document.querySelector(".video-player .more-media"),
                                    t = document.querySelector(".video-player .vjs-actions-anim");
                                this.upNextLoaderView.cancelTimer();
                                var n = o.MediaPageStore.get("playlist-next-media-url");
                            ...
                            this.upNextLoaderView && (o.PageStore.get("media-auto-play") ? (this.upNextLoaderView.startTimer(), this.playerInstance.player.one("play", function() {
                                this.upNextLoaderView.cancelTimer()
                            }.bind(this))) : this.upNextLoaderView.cancelTimer())
                        }
                    }, {
                        ...
                        value: function() {
                            var e = this,
                                t = null,
                                n = null;
                            !this.props.inEmbed && o.MediaPageStore.get("playlist-id") ? (t = o.MediaPageStore.get("playlist-next-media-url"), n = o.MediaPageStore.get("playlist-previous-media-url")) : t = this.props.data.related_media.length && !this.props.inEmbed ? this.props.data.related_media[0].url : null;
                ...
                function L(e) {
                    for (var t = null, n = [], r = location.search.substr(1).split("&"), a = 0; a < r.length; a++)(n = r[a].split("="))[0] === e && (t = decodeURIComponent(n[1]));
                    return t
                }
                R.defaultProps = {
                    inEmbed: !0,
                    ...
                    if (r) return (n = videojs(r)).playsinline(!0), 1 == L("muted") && n.muted(!0), L("time") >= 0 && n.currentTime(L("time")), 1 == L("autoplay") && n.play(), void t.disconnect()
                })).observe(document, {
                    childList: !0,
                    subtree: !0
                }), n(9808);
                var D, U, B = n(2546),
                    F = n(4234),
                    q = (n(7441), n(6453), n(7390), n(4669), n(2070), n(9511)),
                    z = n(3064),
                    H = (n(4486), n(6429), n(1283));
                ...
                D = void 0, U = function(e) {
                    ...
                    n.default.plugin("markers", (function(e) {
                            ...
                            n.default.mergeOptions = function e(n, r) {
                                ...
                                return [n, r].forEach((function(n) {
                                    n && Object.keys(n).forEach((function(r) {
                                        var i = n[r];
                                        t(i) ? (t(a[r]) || (a[r] = {}), a[r] = e(a[r], i)) : a[r] = i
                                    }))
                                })), a
                            }
                        }
                        ...
                        function h(e) {
                            e.forEach((function(e) {
                                ...
                                e.key = (t = (new Date).getTime(), "xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(/[xy]/g, (function(e) {
                                    ...
                                    return v(e, t), t.addEventListener("click", (function(t) {
                                        var n = !1;
                                        if ("function" == typeof l.onMarkerClick && (n = !1 === l.onMarkerClick(e)), !n) {
                                        ...
                                        e.addEventListener("mouseover", (function() {
                                            ...
                                            if (m) {
                                                m.querySelector(".vjs-tip-inner").innerText = l.markerTip.text(t), m.style.left = g(t) + "%";
                                                var n = i(m),
                                                    r = i(e);
                                                m.style.marginLeft = -parseFloat(n.width / 2) + parseFloat(r.width / 4) + "px", m.style.visibility = "visible"
                                            }
                                        })), e.addEventListener("mouseout", (function() {
                                            m && (m.style.visibility = "hidden")
                                        }))
                                    }(t), t
                                }(e)), s[e.key] = e, u.push(e)
                            })), y()
                        }
                        ...
                        function v(e, t) {
                            t.className = "vjs-marker " + (e.class || ""), Object.keys(l.markerStyle).forEach((function(e) {
                                t.style[e] = l.markerStyle[e]
                            }));
                            var n = e.time / d.duration();
                            if ((n < 0 || n > 1) && (t.style.display = "none"), t.style.left = g(e) + "%", e.duration) t.style.width = e.duration / d.duration() * 100 + "%", t.style.marginLeft = "0px";
                            else {
                                var r = i(t);
                        ...
                        function b(e) {
                            f && (p = o, f.style.visibility = "hidden"), c = o;
                            var t = [];
                            e.forEach((function(e) {
                                var n = u[e];
                                if (n) {
                                    delete s[n.key], t.push(e);
                        ...
                        function S() {
                            if (l.breakOverlay.display && !(c < 0)) {
                                ...
                                e >= n && e <= n + l.breakOverlay.displayTime ? (p !== c && (p = c, f && (f.querySelector(".vjs-break-overlay-text").innerHTML = l.breakOverlay.text(t))), f && (f.style.visibility = "visible")) : (p = o, f && (f.style.visibility = "hidden"))
                            }
                        }
                        ...
                        function w() {
                            ! function() {
                                if (u.length) {
                                    ...
                                    if (c !== o) {
                                        var a = t(c);
                                        if (n >= l.markerTip.time(u[c]) && n < a) return;
                                        if (c === u.length - 1 && n === d.duration()) return
                                    }
                                    if (n < l.markerTip.time(u[0])) r = o;
                                    else
                                        for (var i = 0; i < u.length; i++)
                                            if (a = t(i), n >= l.markerTip.time(u[i]) && n < a) {
                                                r = i;
                                                break
                                            } r !== c && (r !== o && e.onMarkerReached && e.onMarkerReached(u[r], r), c = r)
                                }
                            }(), S(), e.onTimeUpdateAfterMarkerUpdate && e.onTimeUpdateAfterMarkerUpdate()
                        }
                        d.on("loadedmetadata", (function() {
                            l.markerTip.display && (m = n.default.createEl("div", {
                                className: "vjs-tip",
                                innerHTML: "<div class='vjs-tip-arrow'></div><div class='vjs-tip-inner'></div>"
                            }), d.el().querySelector(".vjs-progress-holder").appendChild(m)), d.markers.removeAll(), h(l.markers), l.breakOverlay.display && (f = n.default.createEl("div", {
                                className: "vjs-break-overlay",
                                innerHTML: "<div class='vjs-break-overlay-text'></div>"
                            }), Object.keys(l.breakOverlay.style).forEach((function(e) {
                                f && (f.style[e] = l.breakOverlay.style[e])
                            })), d.el().appendChild(f), p = o), w(), d.on("timeupdate", w), d.off("loadedmetadata")
                        })), d.markers = {
                            getMarkers: function() {
                                return u
                            },
                            ...
                            prev: function() {
                                for (var e = d.currentTime(), t = u.length - 1; t >= 0; t--) {
                                    var n = l.markerTip.time(u[t]);
                                    if (n + .5 < e) return void d.currentTime(n)
                                }
                            },
                            add: function(e) {
                                h(e)
                            ...
                            removeAll: function() {
                                for (var e = [], t = 0; t < u.length; t++) e.push(t);
                                b(e)
                            },
                            updateTime: function(e) {
                                ! function(e) {
                                    u.forEach((function(t) {
                                        ...
                                        (e || n.getAttribute("data-marker-time") !== r) && (v(t, n), n.setAttribute("data-marker-time", r))
                                    })), y()
                                }(e)
                            },
                            reset: function(e) {
                                d.markers.removeAll(), h(e)
                            },
                            destroy: function() {
                                d.markers.removeAll(), f && f.remove(), m && m.remove(), d.off("timeupdate", S), delete d.markers
                            }
                        }
                    }))
                }, "function" == typeof define && n.amdO ? define(["mediacms-player"], U) : "undefined" != typeof exports ? U(n(8009)) : (U((D = window).videojs), D.videojsMarkers = {});
                var $ = n(1283);
                ...
                function ee(e) {
                    var t = (0, a.useRef)(null),
                        ...
                        r = n[0],
                        l = n[1],
                        s = Y((0, a.useState)(!1), 2),
                        u = s[0],
                        c = s[1],
                        d = Y((0, a.useState)(!1), 2),
                        m = d[0],
                        p = d[1],
                        y = Y((0, a.useState)(-1), 2),
                        h = y[0],
                        g = y[1],
                        v = Y((0, a.useState)(""), 2),
                        b = v[0],
                        S = v[1],
                        w = Y((0, a.useState)(i.MemberContext._currentValue.is.anonymous ? i.LinksContext._currentValue.signin + "?next=/" + window.location.href.replace(i.SiteContext._currentValue.url, "").replace(/^\//g, "") : null), 1)[0];
                    ...
                    function _() {
                        ...
                        l(""), c(!1), g(n), t.current.style.height = Math.max(20, h * Math.ceil(e / n)) + "px"
                    }
                    ...
                    return (0, a.useEffect)((function() {
                        return o.MediaPageStore.on("comment_submit", _), o.MediaPageStore.on("comment_submit_fail", M), !0 === MediaCMS.features.media.actions.comment_mention && o.MediaPageStore.on("users_load", k),
                            function() {
                                o.MediaPageStore.removeListener("comment_submit", _), o.MediaPageStore.removeListener("comment_submit_fail", M), !0 === MediaCMS.features.media.actions.comment_mention && o.MediaPageStore.removeListener("users_load", k)
                            }
                        ...
                        onChange: function(e) {
                            ...
                            l(t.current.value), c(!0), g(r), t.current.style.height = Math.max(20, h * Math.ceil(n / r)) + "px"
                        },
                        onFocus: E,
                        onBlur: P
                    })), a.createElement("div", {
                ...
                function te(e) {
                    ...
                    return a.createElement("div", {
                        ...
                        onClick: function() {
                            n.current.toggle(), f.MediaPageActions.deleteComment(e.comment_id)
                        }
                    }, "PROCEED"))))) : null)
                }

                function ne(e) {
                    var t, n = (0, a.useRef)(null),
                        r = (0, a.useRef)(null),
                        o = Y((0, a.useState)(!0), 2),
                        l = o[0],
                        s = o[1],
                        u = Y((0, a.useState)(!1), 2),
                        c = u[0];
                    return u[1], (0, a.useEffect)((function() {
                        return function() {}
                    }), []), a.createElement("div", {
                        className: "comment"
                    }, a.createElement("div", {
                    ...
                    }, (0, z.WU)(new Date(e.publish_date)))), a.createElement("div", {
                        ref: n,
                ...
                function ae(e) {
                    var t = Y((0, a.useState)(o.MediaPageStore.get("media-id")), 2),
                        n = t[0],
                        r = (t[1], Y((0, a.useState)(i.MemberContext._currentValue.can.readComment ? o.MediaPageStore.get("media-comments") : []), 2)),
                        l = r[0],
                        s = r[1],
                        u = Y((0, a.useState)(!1), 2),
                        c = u[0],
                    ...
                    return (0, a.useEffect)((function() {
                        ...
                        return o.MediaPageStore.on("comments_load", m), o.MediaPageStore.on("comment_submit", p), o.MediaPageStore.on("comment_submit_fail", y), o.MediaPageStore.on("comment_delete", h), o.MediaPageStore.on("comment_delete_fail", g),
                            function() {
                                o.MediaPageStore.removeListener("comments_load", m), o.MediaPageStore.removeListener("comment_submit", p), o.MediaPageStore.removeListener("comment_submit_fail", y), o.MediaPageStore.removeListener("comment_delete", h), o.MediaPageStore.removeListener("comment_delete_fail", g)
                            }
                    }), []), a.createElement("div", {
                ...
                function se(e) {
                    var t, n, r = [];
                    if (e.length)
                        for (t = 0, n = 1 < e.length ? ", " : ""; t < e.length;) r[t] = a.createElement("div", {
                            key: t
                        }, a.createElement("a", {
                            href: e[t].url,
                            title: e[t].title
                        }, e[t].title), t < e.length - 1 ? n : ""), t += 1;
                    return r
                }
                ...
                function de(e) {
                    var t = e.link;
                    return window.MediaCMS.site.devEnv && (t = "/edit-media.html"), a.createElement("a", {
                        href: t,
                        rel: "nofollow",
                        title: "Edit media",
                ...
                function fe(e) {
                    ...
                    s = s ? s.trim() : "";
                    var u = oe((0, B.usePopup)(), 3),
                        c = u[0],
                        d = u[1],
                        p = u[2],
                        y = oe((0, a.useState)("" !== s), 2),
                        h = y[0],
                        g = (y[1], oe((0, a.useState)("" == s), 2)),
                        v = g[0],
                        b = g[1];

                    function S(e) {
                        setTimeout((function() {
                            f.PageActions.addNotification("Media removed. Redirecting...", "mediaDelete"), setTimeout((function() {
                                window.location.href = i.SiteContext._currentValue.url + "/" + o.MediaPageStore.get("media-data").author_profile.replace(/^\//g, "")
                            }), 2e3)
                        }), 100), void 0 !== e && ie.info("Removed media '" + e + '"')
                    }

                    function w(e) {
                        setTimeout((function() {
                            f.PageActions.addNotification("Media removal failed", "mediaDeleteFail")
                        }), 100), void 0 !== e && ie.info('Media "' + e + '" removal failed')
                    }(0, a.useEffect)((function() {
                        return o.MediaPageStore.on("media_delete", S), o.MediaPageStore.on("media_delete_fail", w),
                            function() {
                                o.MediaPageStore.removeListener("media_delete", S), o.MediaPageStore.removeListener("media_delete_fail", w)
                            }
                    }), []);
                    var E = (0, m.formatInnerLink)(e.author.url, i.SiteContext._currentValue.url),
                        P = (0, m.formatInnerLink)(e.author.thumb, i.SiteContext._currentValue.url);
                    return a.createElement("div", {
                        ...
                        className: "button-link proceed-comment-removal",
                        onClick: function() {
                            f.MediaPageActions.removeMedia(), c.current.toggle()
                        }
                ...
                function he() {
                    var e = pe((0, a.useState)(o.MediaPageStore.get("user-disliked-media")), 2),
                        t = e[0],
                        n = e[1],
                        r = pe((0, a.useState)((0, m.formatViewsNumber)(o.MediaPageStore.get("media-dislikes"), !1)), 2),
                        l = r[0],
                        s = r[1];

                    function u() {
                        n(o.MediaPageStore.get("user-disliked-media")), s((0, m.formatViewsNumber)(o.MediaPageStore.get("media-dislikes"), !1))
                    }

                    function c() {
                        u(), f.PageActions.addNotification(i.TextsContext._currentValue.messages.addToDisliked, "mediaDislike")
                    }

                    function d() {
                        u(), f.PageActions.addNotification(i.TextsContext._currentValue.messages.removeFromDisliked, "cancelMediaDislike")
                    }
                    ...
                    return (0, a.useEffect)((function() {
                        return o.MediaPageStore.on("disliked_media", c), o.MediaPageStore.on("undisliked_media", d), o.MediaPageStore.on("disliked_media_failed_request", p),
                            function() {
                                o.MediaPageStore.removeListener("disliked_media", c), o.MediaPageStore.removeListener("undisliked_media", d), o.MediaPageStore.removeListener("disliked_media_failed_request", p)
                            }
                    }), []), a.createElement("div", {
                        className: "like"
                    }, a.createElement("button", {
                        onClick: function(e) {
                            e.preventDefault(), e.stopPropagation(), f.MediaPageActions[t ? "undislikeMedia" : "dislikeMedia"]()
                        }
                ...
                function be() {
                    var e = ge((0, a.useState)(o.MediaPageStore.get("user-liked-media")), 2),
                        t = e[0],
                        n = e[1],
                        r = ge((0, a.useState)((0, m.formatViewsNumber)(o.MediaPageStore.get("media-likes"), !1)), 2),
                        l = r[0],
                        s = r[1];

                    function u() {
                        n(o.MediaPageStore.get("user-liked-media")), s((0, m.formatViewsNumber)(o.MediaPageStore.get("media-likes"), !1))
                    }

                    function c() {
                        u(), f.PageActions.addNotification(i.TextsContext._currentValue.addToLiked, "likedMedia")
                    }

                    function d() {
                        u(), f.PageActions.addNotification(i.TextsContext._currentValue.removeFromLiked, "unlikedMedia")
                    }
                    ...
                    return (0, a.useEffect)((function() {
                        return o.MediaPageStore.on("liked_media", c), o.MediaPageStore.on("unliked_media", d), o.MediaPageStore.on("liked_media_failed_request", p),
                            function() {
                                o.MediaPageStore.removeListener("liked_media", c), o.MediaPageStore.removeListener("unliked_media", d), o.MediaPageStore.removeListener("liked_media_failed_request", p)
                            }
                    }), []), a.createElement("div", {
                        className: "like"
                    }, a.createElement("button", {
                        onClick: function(e) {
                            e.preventDefault(), e.stopPropagation(), f.MediaPageActions[t ? "unlikeMedia" : "likeMedia"]()
                        }
                    }, a.createElement(F.CircleIconButton, {
                        type: "span"
                    }, a.createElement(F.MaterialIcon, {
                ...
                function we(e) {
                    var t, n, r = (0, a.useRef)(null),
                        i = (0, a.useRef)(null),
                        l = (t = (0, a.useState)(null), n = 2, function(e) {
                            if (Array.isArray(e)) return e
                        }(t) || function(e, t) {
                            var n = null == e ? null : "undefined" != typeof Symbol && e[Symbol.iterator] || e["@@iterator"];
                            if (null != n) {
                    ...
                    return (0, a.useEffect)((function() {
                        return c(), o.PageStore.on("window_resize", c),
                            function() {
                        ...
                        className: "cancel",
                        onClick: function(t) {
                            t.preventDefault(), void 0 !== e.cancelReportForm && e.cancelReportForm()
                        }
                    }, "CANCEL"), a.createElement("button", {
                        onClick: function(t) {
                ...
                function ke(e, t) {
                    var n, r, a = i.SiteContext._currentValue,
                        o = e.encodings_info,
                        l = {};
                    for (n in o)
                        if (o.hasOwnProperty(n) && Object.keys(o[n]).length)
                            for (r in o[n]) o[n].hasOwnProperty(r) && "success" === o[n][r].status && 100 === o[n][r].progress && (l[o[n][r].title] = {
                                text: n + " - " + r.toUpperCase() + " (" + o[n][r].size + ")",
                                link: (0, m.formatInnerLink)(o[n][r].url, a.url),
                                linkAttr: {
                                    target: "_blank",
                    ...
                    return l.original_media_url = {
                        ...
                        link: (0, m.formatInnerLink)(e.original_media_url, a.url),
                        linkAttr: {
                            target: "_blank",
                            download: e.title
                        }
                ...
                function _e(e, t, n, r, i, o, l) {
                    ...
                    return y.length && (h.main = a.createElement("div", {
                        ...
                        className: "reports"
                    }, "Reports: ", a.createElement("span", null, m)) : null)))), n && e.downloadMedia && p && (h.videoDownloadOptions = a.createElement("div", {
                ...
                function Ae(e) {
                    var t = (0, B.useUser)().userCan,
                        ...
                        r = (0, m.formatInnerLink)(o.MediaPageStore.get("media-original-url"), n.url),
                        ...
                        h = y[0],
                        g = y[1],
                        v = Ee((0, a.useState)(!1), 2),
                        b = v[0],
                        S = v[1],
                        w = Ee((0, a.useState)({}), 2),
                        E = w[0],
                        P = w[1],
                        k = Ee((0, a.useState)("main"), 2),
                        _ = k[0],
                        M = k[1],
                        A = Ee((0, a.useState)(Me), 2),
                        C = A[0],
                        N = A[1];
                    ...
                    function I() {
                        c.current.tryToHide(), setTimeout((function() {
                            f.PageActions.addNotification("Media Reported", "reportedMedia"), S(!0), o.MediaPageStore.removeListener("reported_media", I)
                        }), 100)
                    }
                    return (0, a.useEffect)((function() {
                        ...
                        var n = Me;
                        e.allowDownload && t.downloadMedia && "videoDownloadOptions" === _ && (n += " video-downloads"), 1 === Object.keys(E).length && e.allowDownload && t.downloadMedia && (s || r) && (n += " visible-only-in-small"), N(n)
                ...
                function Oe(e) {
                    return e.renderDate ? a.createElement("label", null, a.createElement("input", {
                        ...
                        checked: e.isChecked,
                        onChange: function(t) {
                            t.persist(), e.isChecked ? f.MediaPageActions.removeMediaFromPlaylist(e.playlistId, o.MediaPageStore.get("media-id")) : f.MediaPageActions.addMediaToPlaylist(e.playlistId, o.MediaPageStore.get("media-id"))
                        }
                ...
                function Ie(e) {
                    var t = (0, a.useRef)(null),
                        n = (0, a.useRef)(null),
                        r = Ne((0, a.useState)(new Date), 2),
                        i = r[0],
                        l = r[1],
                        s = Ne((0, a.useState)(o.MediaPageStore.get("playlists")), 2),
                        u = s[0],
                        c = s[1],
                        d = Ne((0, a.useState)(!1), 2),
                        m = d[0],
                        p = d[1];
                    ...
                    function h() {
                        c(o.MediaPageStore.get("playlists")), l(new Date)
                    }

                    function g() {
                        c(o.MediaPageStore.get("playlists")), l(new Date), setTimeout((function() {
                    ...
                    return (0, a.useEffect)((function() {
                        ...
                        return o.PageStore.on("window_resize", y), o.MediaPageStore.on("playlists_load", h), o.MediaPageStore.on("media_playlist_addition_completed", g), o.MediaPageStore.on("media_playlist_addition_failed", v), o.MediaPageStore.on("media_playlist_removal_completed", b), o.MediaPageStore.on("media_playlist_removal_failed", S),
                            function() {
                                o.PageStore.removeListener("window_resize", y), o.MediaPageStore.removeListener("playlists_load", h), o.MediaPageStore.removeListener("media_playlist_addition_completed", g), o.MediaPageStore.removeListener("media_playlist_addition_failed", v), o.MediaPageStore.removeListener("media_playlist_removal_completed", b), o.MediaPageStore.removeListener("media_playlist_removal_failed", S)
                            }
                    }), []), a.createElement("div", {
                        ref: t,
                        ...
                        type: "button",
                        onClick: function() {
                            p(!1), void 0 !== e.triggerPopupClose && e.triggerPopupClose()
                        }
                    }, a.createElement(F.MaterialIcon, {
                        type: "close"
                        ...
                        for (var e = o.MediaPageStore.get("media-id"), t = [], n = 0; n < u.length;) t.push(a.createElement("div", {
                        ...
                        onPlaylistSave: function(e) {
                            f.MediaPageActions.addNewPlaylist(e), E()
                        }
                    })) : a.createElement(F.CircleIconButton, {
                ...
                function je(e) {
                    var t, n = Te((0, B.usePopup)(), 3),
                        r = n[0],
                        i = n[1],
                        o = n[2],
                        l = Te((0, a.useState)("selectPlaylist"), 2),
                        s = l[0],
                        u = l[1];
                    return a.createElement("div", {
                        className: "save"
                ...
                function De(e) {
                    var t = o.PageStore.get("config-options").embedded.video.dimensions,
                        n = (0, a.useContext)(i.LinksContext),
                        r = (0, a.useRef)(null),
                        l = (0, a.useRef)(null),
                        s = (0, a.useRef)(null),
                        u = (0, a.useRef)(null),
                        c = (0, a.useRef)(null),
                        d = Re((0, a.useState)(window.innerHeight - 144 + 56), 2),
                        m = d[0],
                        p = d[1],
                        y = Re((0, a.useState)(!1), 2),
                        h = y[0],
                        g = y[1],
                        v = Re((0, a.useState)("16:9"), 2),
                        b = v[0],
                        S = v[1],
                        w = Re((0, a.useState)(t.width), 2),
                        E = w[0],
                        P = w[1],
                        k = Re((0, a.useState)(t.widthUnit), 2),
                        _ = k[0],
                        M = k[1],
                        A = Re((0, a.useState)(t.height), 2),
                        C = A[0],
                        N = A[1],
                        x = Re((0, a.useState)(t.heightUnit), 2),
                        O = x[0],
                        I = x[1],
                        T = Re((0, a.useState)(60), 2),
                        V = T[0],
                        j = T[1],
                        L = Re((0, a.useState)(60), 2),
                        D = L[0],
                        U = L[1],
                        B = Re((0, a.useState)([{
                            key: "px",
                    ...
                    function H() {
                        p(window.innerHeight - 144 + 56), j(s.current.offsetHeight), U(c.current.offsetHeight)
                    }
                    ...
                    return (0, a.useEffect)((function() {
                        ...
                        return o.PageStore.on("window_resize", H), o.MediaPageStore.on("copied_embed_media_code", W),
                            function() {
                                o.PageStore.removeListener("window_resize", H), o.MediaPageStore.removeListener("copied_embed_media_code", W)
                            }
                    }), []), a.createElement("div", {
                        ...
                        onChange: function() {
                            var e = !h,
                                ...
                                n = t[0],
                                r = t[1];
                            g(e), M(e ? "px" : _), I(e ? "px" : O), N(e ? parseInt(E * r / n, 10) : C), z(e ? [{
                                key: "px",
                                label: "px"
                            }] : [{
                                key: "px",
                ...
                }, n(8833), n(815), n(9174), De.propTypes = {
                    triggerPopupClose: u().func
                }, n(5777);
                var Ue = n(3458);
                ...
                function We(e) {
                    var t = (0, a.useRef)(null),
                        ...
                        d = c[0],
                        m = c[1],
                        p = Be((0, a.useState)(He()), 2),
                        y = p[0],
                        h = p[1],
                        g = Be((0, a.useState)(function() {
                            var e = function() {
                                ...
                                t = [];
                            for (var n in e) e.hasOwnProperty(n) && ("embed" === n ? t.push(a.createElement("div", {
                                key: "share-" + n,
                        ...
                        v = Be((0, a.useState)(0), 2),
                        b = v[0],
                        S = v[1],
                        w = Be((0, a.useState)(0), 2),
                        E = w[0],
                        P = w[1],
                        k = Be((0, a.useState)(!1), 2),
                        _ = k[0],
                        M = k[1],
                        A = Be((0, a.useState)(r), 2),
                        C = A[0],
                        N = A[1];
                    ...
                    return (0, a.useEffect)((function() {
                        ...
                        s && (s.updateDataStateOnResize(g.length, !0, !0), I())
                    }), [y, s]), (0, a.useEffect)((function() {
                        o.PageStore.on("window_resize", x), o.MediaPageStore.on("copied_media_link", O);
                        var e, t, n, r, a, i = null === (e = document.getElementsByTagName("video")[0]) || void 0 === e ? void 0 : e.currentTime;
                        return S(i), P((a = (t = parseInt(i, 10)) - 3600 * (n = Math.floor(t / 3600)) - 60 * (r = Math.floor((t - 3600 * n) / 60)), n < 10 && (n = "0" + n), r < 10 && (r = "0" + r), a < 10 && (a = "0" + a), n >= 1 ? n + ":" + r + ":" + a : r + ":" + a)),
                            function() {
                                o.PageStore.removeListener("window_resize", x), o.MediaPageStore.removeListener("copied_media_link", O), u(null)
                            }
                    }), []), a.createElement("div", {
                        ref: t,
                        ...
                        onChange: function() {
                            var e;
                            M(!_), e = _ ? r : r + "&t=" + Math.trunc(b), N(e)
                        }
                    }), "Start at ", E)))
                }
                ...
                function Ke(e) {
                    var t, n = $e((0, B.usePopup)(), 3),
                        r = n[0],
                        i = n[1],
                        o = n[2],
                        l = $e((0, a.useState)("shareOptions"), 2),
                        s = l[0],
                        u = l[1];
                    return a.createElement("div", {
                        className: "share"
                ...
                function nt() {
                    var e, t, n = o.MediaPageStore.get("media-data"),
                        r = (n.title, n.encodings_info),
                        a = {};
                    for (e in r)
                        if (r.hasOwnProperty(e) && Object.keys(r[e]).length)
                            for (t in r[e]) r[e].hasOwnProperty(t) && "success" === r[e][t].status && 100 === r[e][t].progress && (a[r[e][t].title] = {
                                text: e + " - " + t.toUpperCase() + " (" + r[e][t].size + ")",
                                link: (0, m.formatInnerLink)(r[e][t].url, i.SiteContext._currentValue.url),
                                linkAttr: {
                                    target: "_blank",
                    ...
                    return a.original_media_url = {
                        ...
                        link: (0, m.formatInnerLink)(n.original_media_url, i.SiteContext._currentValue.url),
                        linkAttr: {
                            target: "_blank",
                            download: n.title
                        }
                ...
                function rt(e) {
                    var t = et((0, B.usePopup)(), 3),
                        n = t[0],
                        r = t[1],
                        i = t[2],
                        o = et((0, a.useState)("main"), 2),
                        l = o[0];
                    return o[1], a.createElement("div", {
                ...
                var ct = function(e) {
                    ...
                    function u(e) {
                        ...
                        }, t.downloadLink = "video" !== o.MediaPageStore.get("media-type") ? (0, m.formatInnerLink)(o.MediaPageStore.get("media-original-url"), i.SiteContext._currentValue.url) : null, t.updateStateValues = t.updateStateValues.bind(st(t)), t
                    }
                    return t = u, (n = [{
                        key: "componentDidMount",
                        value: function() {
                            o.MediaPageStore.on("liked_media", this.updateStateValues), o.MediaPageStore.on("unliked_media", this.updateStateValues), o.MediaPageStore.on("disliked_media", this.updateStateValues), o.MediaPageStore.on("undisliked_media", this.updateStateValues);
                            ...
                            e.length && e.forEach((function(e) {
                                return function(e) {
                                    ...
                                    function r() {
                                        ...
                                        n.style.top = t.top - (0 + n.offsetHeight) + "px", n.style.left = t.left + "px"
                                    }
                                    n.innerText = e.getAttribute("data-tooltip"), n.setAttribute("class", "tooltip"), e.removeAttribute("data-tooltip"), e.addEventListener("mouseenter", (function() {
                                        var a = e.getBoundingClientRect();
                                        t.appendChild(n), n.style.top = a.top - (0 + n.offsetHeight) + "px", n.style.left = a.left + "px", document.addEventListener("scroll", r)
                                    })), e.addEventListener("mouseleave", (function() {
                                        t.removeChild(n), n.style.top = "", n.style.left = "", document.removeEventListener("scroll", r)
                                    }))
                                }(e)
                            }))
                        }
                        ...
                        key: "mediaCategories",
                        value: function(e) {
                            if (void 0 === this.props.categories || null === this.props.categories || !this.props.categories.length) return null;
                            for (var t = 0, n = []; t < this.props.categories.length;) n.push(a.createElement("span", {
                                key: t
                            }, a.createElement("a", {
                                href: (0, m.formatInnerLink)(this.props.categories[t].url, i.SiteContext._currentValue.url),
                                title: this.props.categories[t].title
                            }, this.props.categories[t].title))), t += 1;
                            return a.createElement("div", {
                ...
                var gt = function(e) {
                    ...
                    function u() {
                        return mt(this, u), s.apply(this, arguments)
                    }
                    return t = u, (n = [{
                        key: "render",
                        value: function() {
                ...
                var xt = function(e) {
                    ...
                    function s() {
                        return _t(this, s), l.apply(this, arguments)
                    }
                    return t = s, (n = [{
                        key: "render",
                        value: function() {
                            var e, t, n, r, i, l, s = !1;
                            return this.state.videoLoaded && (s = void 0 === (s = o.MediaPageStore.get("media-data").allow_download) || !!s, e = o.MediaPageStore.get("media-data").views, t = o.MediaPageStore.get("media-data").categories_info, n = o.MediaPageStore.get("media-data").title, r = {
                            ...
                            }, i = o.MediaPageStore.get("media-data").add_date, l = o.MediaPageStore.get("media-data").description), this.state.videoLoaded ? a.createElement("div", {
                    ...
                    function s(e) {
                        ...
                        return function(e, t) {
                            if (!(e instanceof t)) throw new TypeError("Cannot call a class as a function")
                        }(this, s), (t = l.call(this, e)).state = {
                            videoLoaded: !1
                        }, t.onVideoLoad = t.onVideoLoad.bind(Et(t)), o.MediaPageStore.on("loaded_media_data", t.onVideoLoad), t
                    }
                    return t = s, (n = [{
                        key: "onVideoLoad",
                        value: function() {
                ...
                var Lt = function(e) {
                        ...
                        function s() {
                            return It(this, s), l.apply(this, arguments)
                        }
                        return t = s, (n = [{
                            key: "render",
                            value: function() {
                ...
                function qt(e) {
                    var t = Ut((0, a.useState)(Ft()), 2),
                        n = t[0],
                        r = t[1],
                        i = Ut((0, a.useState)(o.PageStore.get("media-auto-play")), 2),
                        l = i[0],
                        s = i[1];
                    ...
                    return (0, a.useEffect)((function() {
                        return o.MediaPageStore.on("loaded_media_data", c), o.PageStore.on("switched_media_auto_play", u),
                            function() {
                                o.MediaPageStore.removeListener("loaded_media_data", c), o.PageStore.removeListener("switched_media_auto_play", u)
                            }
                ...
                function Wt(e) {
                    var t = zt((0, a.useState)(c()), 2),
                        n = t[0],
                        r = t[1],
                        i = zt((0, a.useState)(null), 2),
                        l = i[0],
                        s = i[1];

                    function u() {
                        s(o.MediaPageStore.get("media-type")), r(c())
                    }
                ...
                var Xt = function(e) {
                    ...
                    function u(e) {
                        ...
                        }, t.onHeaderClick = t.onHeaderClick.bind(Jt(t)), t.onLoopClick = t.onLoopClick.bind(Jt(t)), t.onShuffleClick = t.onShuffleClick.bind(Jt(t)), t.onSaveClick = t.onSaveClick.bind(Jt(t)), t.onLoopRepeatUpdate = t.onLoopRepeatUpdate.bind(Jt(t)), t.onShuffleUpdate = t.onShuffleUpdate.bind(Jt(t)), t.onPlaylistSaveUpdate = t.onPlaylistSaveUpdate.bind(Jt(t)), o.PlaylistViewStore.on("loop-repeat-updated", t.onLoopRepeatUpdate), o.PlaylistViewStore.on("shuffle-updated", t.onShuffleUpdate), o.PlaylistViewStore.on("saved-updated", t.onPlaylistSaveUpdate), t
                    }
                    return t = u, (n = [{
                        key: "onHeaderClick",
                        value: function(e) {
                ...
                var ln = function(e) {
                    ...
                    function s(e) {
                        ...
                        return t.onMediaLoad = t.onMediaLoad.bind(an(t)), t
                    }
                    return t = s, (n = [{
                        key: "componentDidMount",
                        value: function() {
                ...
                var pn = function(e) {
                    ...
                    function s(e) {
                        ...
                        return function(e, t) {
                            if (!(e instanceof t)) throw new TypeError("Cannot call a class as a function")
                        }(this, s), (t = l.call(this, e, "media")).state = {
                        ...
                        }, t.onWindowResize = t.onWindowResize.bind(mn(t)), t.onMediaLoad = t.onMediaLoad.bind(mn(t)), t.onMediaLoadError = t.onMediaLoadError.bind(mn(t)), t.onPagePlaylistLoad = t.onPagePlaylistLoad.bind(mn(t)), o.MediaPageStore.on("loaded_media_data", t.onMediaLoad), o.MediaPageStore.on("loaded_media_error", t.onMediaLoadError), o.MediaPageStore.on("loaded_page_playlist_data", t.onPagePlaylistLoad), t
                    }
                    return t = s, (n = [{
                        key: "componentDidMount",
                        value: function() {
                            f.MediaPageActions.loadMediaData(), o.PageStore.on("window_resize", this.onWindowResize)
                        }
                    }, {
                        key: "onWindowResize",
                        value: function() {
                        ...
                        value: function() {
                            ...
                            e ? (this.onViewerModeChange = this.onViewerModeChange.bind(this), o.VideoViewerStore.on("changed_viewer_mode", this.onViewerModeChange), this.setState({
                                mediaLoaded: !0,
                                isVideoMedia: e,
                ...
                if (window.MediaCMS.site.devEnv) {
                    var wn = function() {
                        ...
                        En = wn.mediaId,
                        Pn = wn.playlistId;
                    En && (window.MediaCMS.mediaId = En), Pn && (window.MediaCMS.playlistId = Pn)
                }
                var kn = function(e) {
                    ! function(e, t) {
                        if ("function" != typeof t && null !== t) throw new TypeError("Super expression must either be null or a function");
                    ...
                    function c() {
                        return hn(this, c), u.apply(this, arguments)
                    }
                    return t = c, (n = [{
            ...
            2436: function(e, t, n) {
                ...
                }), n(2070), n(1646), n(2004), n(8407), n(6394), n(8288), n(5677), n(2129), n(4655), n(288), n(4458), n(3675);
                var r = n(5466),
                    a = n(7959);
                    ...
                    return (0, r.useEffect)((function() {
                        return u = setTimeout((function() {
                                c = setTimeout((function() {
                                    s(!1), c = null
                                }), 1e3), u = null, a(!0), e.onHide(e.id)
                            }), 5e3),
                            function() {
                                u && clearTimeout(u), c && clearTimeout(c)
                            }
                ...
                function d() {
                    var e, t, n, l = o((0, r.useState)(u.length), 2),
                        s = l[0],
                        d = l[1];
                    ...
                    return (0, r.useEffect)((function() {
                        return m(), a.default.on("added_notification", m),
                            function() {
                                return a.default.removeListener("added_notification", m)
                            }
                    }), []), s ? r.createElement("div", {
                        className: "notifications"
                    }, r.createElement("div", null, (e = a.default.get("notifications"), t = u.map((function(e) {
                        ...
                        return u.push(e), r.createElement(c, {
                            key: e[0],
                            id: e[0],
                            onHide: f
                        }, e[1])
                ...
                function s(e) {
                    ...
                    return (0, r.useEffect)((function() {
                        l(function(e, t, n) {
                            if (void 0 !== e) {
                                var r;
                                return r = void 0 !== t && t > e ? t : e, void 0 !== n && n < r ? n : r
                            }
                            return void 0 !== t ? t : void 0 !== n ? n : void 0
                        }(0 + e.defaultValue, e.minValue, e.maxValue)), c(function(e, t) {
                            if (!t || !t.length) return null;
                            for (var n = 0; n < t.length;) {
                                if (void 0 !== t[n].key && e === t[n].key) return t[n].key;
                                n += 1
                            }
                            return t[0].key
                        ...
                        onChange: function() {
                            l(t.current.value), void 0 !== e.valueCallback && e.valueCallback(t.current.value)
                        }
                    }), r.createElement("select", {
                        ref: n,
                        className: "value-unit",
                        onChange: function() {
                            c(n.current.value), void 0 !== e.unitCallback && e.unitCallback(n.current.value)
                        },
                        value: null !== u ? u : ""
                    }, function() {
                        if (!e.units.length) return null;
                        for (var t = [], n = 0; n < e.units.length;) void 0 !== e.units[n].key && t.push(r.createElement("option", {
                            key: e.units[n].key,
                            value: e.units[n].key
                        }, void 0 !== e.units[n].label ? e.units[n].label : e.units[n].key)), n += 1;
                        return t
                    }()))
                }
                s.propTypes = {
            ...
            8727: function(e, t, n) {
                ...
                }), n(2322), n(3296), n(6394), n(4669), n(717), n(5677), n(2129), n(4655), n(6453), n(9006);
                var r = n(5466),
                    a = n(3074),
                    i = n.n(a),
                    o = n(137),
                ...
                function d(e) {
                    ...
                    function s(t) {
                        a.playerVolume !== t.volume && (a.playerVolume = t.volume), a.playerSoundMuted !== t.soundMuted && (a.playerSoundMuted = t.soundMuted), a.videoQuality !== t.quality && (a.videoQuality = t.quality), a.videoPlaybackSpeed !== t.playbackSpeed && (a.videoPlaybackSpeed = t.playbackSpeed), a.inTheaterMode !== t.theaterMode && (a.inTheaterMode = t.theaterMode), void 0 !== e.onStateUpdateCallback && e.onStateUpdateCallback(t)
                    }

                    function c() {
                        if (null === n && null === e.errorMessage && (e.inEmbed || (window.removeEventListener("focus", c), document.removeEventListener("visibilitychange", c)), t.current)) {
                            ...
                            if (void 0 !== e.subtitlesInfo && null !== e.subtitlesInfo && e.subtitlesInfo.length) {
                                f.languages = [];
                                for (var p = 0; p < e.subtitlesInfo.length;) void 0 !== e.subtitlesInfo[p].src && void 0 !== e.subtitlesInfo[p].srclang && void 0 !== e.subtitlesInfo[p].label && f.languages.push({
                                    src: (r = e.subtitlesInfo[p].src, d = e.siteUrl, m = void 0, m = l()(r, {}), "" !== m.origin && "null" !== m.origin && m.origin || (m = l()(d + "/" + r.replace(/^\//g, ""), {})), m.toString()),
                            ...
                            }, e.info, [.25, .5, .75, 1, 1.25, 1.5, 1.75, 2], s, i, o), void 0 !== e.onPlayerInitCallback && e.onPlayerInitCallback(n, t.current)
                        }
                    }
                    return a.playerVolume = null === a.playerVolume ? 1 : Math.max(Math.min(Number(a.playerVolume), 1), 0), a.playerSoundMuted = null !== a.playerSoundMuted && a.playerSoundMuted, a.videoQuality = null !== a.videoQuality ? a.videoQuality : "Auto", a.videoPlaybackSpeed = null !== a.videoPlaybackSpeed && a.videoPlaybackSpeed, a.inTheaterMode = null !== a.inTheaterMode && a.inTheaterMode, (0, r.useEffect)((function() {
                        return e.inEmbed || document.hasFocus() || "visible" === document.visibilityState ? c() : (window.addEventListener("focus", c), document.addEventListener("visibilitychange", c)), n && n.player.one("loadedmetadata", (function() {
            ...
            160: function(e, t, n) {
                ...
                }), n(2322), n(9268), n(9751), n(2004), n(8407), n(6394), n(8288), n(5677), n(2129), n(4655), n(288), n(4458), n(3675);
                var r = n(5466),
                    a = n(3074),
                    i = n.n(a),
                    o = n(137),
                ...
                function h(e) {
                    var t = (0, r.useContext)(s.ApiUrlContext),
                        n = (0, r.useContext)(s.SiteContext),
                        a = p((0, r.useState)(null), 2),
                        i = (a[0], a[1]),
                        o = p((0, r.useState)(null), 2),
                        y = o[0],
                        h = o[1],
                        g = p((0, r.useState)(null), 2),
                        v = g[0],
                        b = g[1],
                        S = p((0, r.useState)([]), 2),
                        w = S[0],
                    ...
                    var T, V = null,
                        j = null,
                        R = null,
                        L = ((T = new(l())(e.pageLink).query) ? ((T = T.substring(1)).split("&"), T = T.length ? T.split("=") : []) : T = [], T);
                    if (L.length)
                        for (var D = 0; D < L.length;) "m" === L[D] && (R = L[D + 1]), D += 2;
                    ...
                    function U(e) {
                        if (void 0 !== e && e && void 0 !== e.data && e.data) {
                            ...
                            var a = [],
                                o = null,
                                l = (0, d.RA)(j.encodings_info, j.hls_info),
                                s = null,
                                c = null;
                            if ("string" == typeof j.poster_url ? o = (0, u.formatInnerLink)(j.poster_url, n.url) : "string" == typeof j.thumbnail_url && (o = (0, u.formatInnerLink)(j.thumbnail_url, n.url)), Object.keys(l).length) {
                                var m = (0, d.KC)(),
                                    p = I.videoQuality;
                                ...
                                for (r in j.encodings_info[y]) j.encodings_info[y].hasOwnProperty(r) && m.support[r] && (t = j.encodings_info[y][r].url) && (t = (0, u.formatInnerLink)(t, n.url), a.push({
                                    src: t,
                                    encodings_status: j.encodings_info[y][r].status
                                }))
                            } else l = null;
                            if (1 === a.length && "running" === a[0].encodings_status && (s = "encodingRunning", c = "Media encoding is currently running. Try again in few minutes."), null !== s) switch (s) {
                                case "encodingRunning":
                                case "encodingPending":
                                case "encodingFailed":
                                    break;
                            ...
                            i(s), h(c), b(o), E(a), _(l), C(j.subtitles_info), O(j.sprites_url ? {
                                url: (0, u.formatInnerLink)(j.sprites_url, n.url),
                                frame: {
                                    width: 160,
                                    height: 90,
                                    seconds: 10
                    ...
                    function B(e) {
                        if (void 0 !== e && void 0 !== e.type) switch (e.type) {
                            case "network":
                            case "private":
                            case "unavailable":
                                i(e.type), h(void 0 !== e.message ? e.message : "Αn error occurred while loading the media's data")
                        }
                    }
                    return null !== R && (V = t.media + "/" + R), (0, r.useEffect)((function() {
                        null !== V && (0, u.getRequest)(V, !1, U, B)
            ...
            8204: function(e, t, n) {
                ...
                }), n(5101), n(3080), n(2004), n(8407), n(6394), n(8288), n(5677), n(2129), n(4655);
                var r = n(5466),
                    a = n(541),
                    i = n(6191),
                    o = n(4234);
                ...
                var m = function(e) {
                    ...
                    function p(e, t) {
                        ...
                        return function(e, t) {
                            if (!(e instanceof t)) throw new TypeError("Cannot call a class as a function")
                        }(this, p), n = f.call(this, e), void 0 !== t && a.PageActions.initPage(t), n
                    }
                    return t = p, (n = [{
                        key: "render",
                        value: function() {
            ...
            9039: function(e, t, n) {
                ...
                }), n(1646), n(288), n(2004), n(8407), n(6394), n(8288), n(5677), n(2129), n(4655), n(3675), n(4458);
                var r = n(4646);
            ...
            9264: function(e, t, n) {
                ...
                function a(e, t) {
                    return r.register(e[t].bind(e)), e
                }
            },
            1397: function(e, t, n) {
                "use strict";
                ...
                }), n(2322), n(3296), n(6394), n(4669);
                var r = n(137),
                    a = n.n(r);

                function i(e, t) {
                    var n = a()(e, {});
                    return "" !== n.origin && "null" !== n.origin && n.origin || (n = a()(t + "/" + e.replace(/^\//g, ""), {})), n.toString()
                }
            },
            705: function(e, t, n) {
                "use strict";
            ...
            4646: function(e, t, n) {
                ...
                }), n(288), n(1646), n(2004), n(8407), n(6394), n(8288), n(5677), n(2129), n(4655), n(3675), n(4458);
                var r = n(1283);
                                ...
                                case 0:
                                    if (s = function(e) {
                                            if (i instanceof Function) {
                                                var t = e;
                                                if (void 0 === e.response) t = {
                                                    type: "network",
                                                    error: e
                                                };
                                                else if (void 0 !== e.response.status) switch (e.response.status) {
                                                    case 401:
                                                        t = {
                                                            type: "private",
                                                            error: e,
                                    ...
                                    return e.next = 6, (0, r.get)(t, o).then(l).catch(s || null);
                                case 6:
                                    e.next = 9;
                                    break;
                                case 8:
                                    (0, r.get)(t, o).then(l).catch(s || null);
                                case 9:
                                case "end":
                                    return e.stop()
                            }
                        ...
                        return regeneratorRuntime.wrap((function(e) {
                            for (;;) switch (e.prev = e.next) {
                                case 0:
                                    ...
                                    return e.next = 6, (0, r.post)(t, n, a || null).then(s).catch(u || null);
                                case 6:
                                    e.next = 9;
                                    break;
                                case 8:
                                    (0, r.post)(t, n, a || null).then(s).catch(u || null);
                                case 9:
                                case "end":
                                    return e.stop()
                            }
                        ...
                        return regeneratorRuntime.wrap((function(e) {
                            for (;;) switch (e.prev = e.next) {
                                case 0:
                                    ...
                                    return e.next = 6, (0, r.put)(t, n, a || null).then(s).catch(u || null);
                                case 6:
                                    e.next = 9;
                                    break;
                                case 8:
                                    (0, r.put)(t, n, a || null).then(s).catch(u || null);
                                case 9:
                                case "end":
                                    return e.stop()
                            }
                        ...
                        return regeneratorRuntime.wrap((function(e) {
                            for (;;) switch (e.prev = e.next) {
                                case 0:
                                    ...
                                    return e.next = 6, a().delete(t, n || null).then(l).catch(s || null);
                                case 6:
                                    e.next = 9;
                                    break;
                                case 8:
            ...
            7959: function(e, t, n) {
                "use strict";
                n.r(t), n(5677), n(6394), n(506), n(3224), n(597), n(3543), n(5210), n(5785), n(91), n(9595), n(3357), n(1816), n(5292), n(7445), n(4875), n(1608), n(2994), n(284), n(601), n(9494), n(6229), n(9149), n(9503), n(9617), n(1962), n(8097), n(2322), n(3296), n(4669), n(7441), n(2070), n(3675), n(2129), n(9268), n(2004), n(8407), n(8288), n(4655), n(288), n(4458), n(5101), n(3080);
                var r, a = n(1590),
                    i = n.n(a),
                    o = n(9722),
                    l = n(473),
                ...
                var h = null,
                    ...
                    v = function(e) {
                        ...
                        function v(e) {
                            ...
                            return function(e, t) {
                                if (!(e instanceof t)) throw new TypeError("Cannot call a class as a function")
                            }(this, v), t = u.call(this), g = (0, s.v)(window.MediaCMS), r = new o.BrowserCache(g.site.id, 86400), (h = {
                                mediaAutoPlay: r.get("media-auto-play")
                            }).mediaAutoPlay = null === h.mediaAutoPlay || h.mediaAutoPlay, t.browserEvents = (0, l.BrowserEvents)(), t.browserEvents.doc(t.onDocumentVisibilityChange.bind(f(t))), t.browserEvents.win(t.onWindowResize.bind(f(t)), t.onWindowScroll.bind(f(t))), t.notifications = function(e) {
                                var t = [];

                                function n(e) {
                                    var n;
                                    "string" == typeof e && t.push([(n = new Uint32Array(3), window.crypto.getRandomValues(n), (performance.now().toString(36) + Array.from(n).map((function(e) {
                            ...
                            }(void 0 !== window.MediaCMS && void 0 !== window.MediaCMS.notifications ? window.MediaCMS.notifications : []), t
                        }
                        return t = v, (n = [{
                ...
                t.default = (0, l.exportStore)(new v, "actions_handler")
            },
            541: function(e, t, n) {
                "use strict";
    ...
    r.m = t, r.amdO = {}, e = [], r.O = function(t, n, a, i) {
            if (!n) {
                var o = 1 / 0;
                for (u = 0; u < e.length; u++) {
                    n = e[u][0], a = e[u][1], i = e[u][2];
                    for (var l = !0, s = 0; s < n.length; s++)(!1 & i || o >= i) && Object.keys(r.O).every((function(e) {
                        return r.O[e](n[s])
                    })) ? n.splice(s--, 1) : (l = !1, i < o && (o = i));
                    l && (e.splice(u--, 1), t = a())
                }
                return t
            }
        ...
        function() {
            ...
            var t = function(t, n) {
                    ...
                    if (s) var c = s(r);
                    for (t && t(n); u < o.length; u++) i = o[u], r.o(e, i) && e[i] && e[i][0](), e[o[u]] = 0;
                    return r.O(c)
                },
